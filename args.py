...
def get_parser():
    ...
    parser.add_argument("--attack_top_k", type=int, default=10)
    parser.add_argument("--embedding_type", type=str, default="glove.840B.300d")
    parser.add_argument("--mapping_strategy", type=str, default="aggressive")
    ...
    parser.add_argument("--s_number", type=int, default=10000)
    parser.add_argument("--final_number", type=int, default=5000)
    return parser
